...
import (
	...
	"github.com/stackitcloud/kubectl-get-all/cmd/internal"
	ketall "github.com/stackitcloud/kubectl-get-all/internal"
...
More on https://github.com/stackitcloud/kubectl-get-all/blob/v1.3.8/doc/USAGE.md#usage
`
	ketallExamples = `
